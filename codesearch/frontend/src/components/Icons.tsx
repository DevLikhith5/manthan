...
export function PromptIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m5.25 8.25 4.5 4.5-4.5 4.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 17.25H18" />
    </svg>
  )
}
...
export function MonogramM({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M3 3h3l6 10 6-10h3v18h-3V8.5L12 18 6 8.5V21H3V3Z" />
    </svg>
  )
}
